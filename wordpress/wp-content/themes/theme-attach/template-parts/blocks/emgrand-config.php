                ...
                >
                    <div class="emg-config__layout">
                                    ...
                                    <div class="emg-config__colors-list">
                                        ...
                                        foreach ( $colors as $c_idx => $color ) :
                                            ...
                                            <button
                                                ...
                                                data-color="<?php echo esc_attr( $color_id ); ?>"
                                                aria-label="<?php echo esc_attr( $color_name ?: 'Color' ); ?>"
                                            ></button>
                                        <?php endforeach; ?>
                                    </div>
                                </div>
                        ...
                        <div class="emg-config__info">
                            ...
                            <div class="emg-config__cta-row">
                                <?php if ( $quote_url ) : ?>
                                    <a class="emg-config__btn emg-config__btn--primary"
                                ...
                                <!-- <?php if ( $sheet_url ) : ?>
                                    <a class="emg-config__btn emg-config__btn--secondary"
                                       href="<?php echo esc_url( $sheet_url ); ?>"
